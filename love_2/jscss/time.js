function showTime() { 
	...
	var startDate = new Date(2017,7,4,17,20,0);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear Xia:<br>"
		...
		+	"<c style=\"color: #e7e6e6; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----taogang   2017-07-04</c>"; 
